...
class ChangePassCC extends Component {
  constructor() {
    super()
    this.state = {
      oldPassword:'',
  ...
  onSubmit(e) {
    ...
    {
      axios.put('http://localhost:5000/contentcreators/changepass/'+decoded._id, {password:this.state.password,newPassword:this.state.newPassword})
    .then(res =>{
