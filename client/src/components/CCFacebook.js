...
class CCFacebook extends Component {
  constructor() {
    super()
    this.state = {
      contentCreator: [],
  ...
  mapContentCreators() {
    ...
    for (let i = 0; i < contentCreator.length; i++) {
      if (contentCreator[i].fbShoutoutPrice === null) {
              ...
              <Grid item xs={12} sm container>
                <Grid item xs container direction="column" spacing={2}>
                  <Grid item xs>
                    ...
                    <b>Facebook Profile Url:</b> <a href={cc.fbLink}>{cc.fbLink}</a><br />
                    </Typography>
                    <Typography variant="body2" color="textSecondary">
                      <b>Content Type:</b> {cc.fbCategory}
                    </Typography>
                  </Grid>
                  <Grid item>
                ...
                <Grid item>
                  <Typography variant="subtitle1"><b>Price:</b> {cc.fbShoutoutPrice}</Typography>
                </Grid>
              </Grid>
            </Grid>
          </Paper>
    ...
    return (
      <div>
        ...
        <div className="content-sec text-center">
              <h2>Facebook Content Creators</h2>
            </div>
          <div className="row">
